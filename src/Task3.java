...
public class Task3 {
    public static void main(String[] args) {
        ...
        if (month == 1 || month == 3 || month == 5 || month == 8 || month == 10 || month == 12){
            day = InputHelper.getRangedInt(scan,"Enter your day you were born",1,31);
        }
        else if (month == 4 || month == 6 || month == 9 || month == 11) {
            day = InputHelper.getRangedInt(scan,"Enter your day you were born",1,30);
        }
        else {
            day = InputHelper.getRangedInt(scan,"Enter your day you were born",1,29);
        }
        int hour = InputHelper.getRangedInt(scan,"Enter the hour you were born",1,24 );
